...
extension FeedStoreSpecs where Self: XCTestCase {
    ...
    func expect(_ sut: FeedStore, toRetrieve expectedResult: FeedStore.RetrieveResult, file: StaticString = #filePath, line: UInt = #line) {
        ...
        sut.retrieve { retrievedResult in
            ...
            case let (.success(.some(expectedCahe)), .success(.some(retrievedCache))):
                XCTAssertEqual(expectedCahe.feed, retrievedCache.feed, file: file, line: line)
                XCTAssertEqual(expectedCahe.timestamp, retrievedCache.timestamp, file: file, line: line)
